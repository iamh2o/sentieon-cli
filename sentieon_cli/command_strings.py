...
def hybrid_stage1_hap(
    ...
    sort_cmd = Command(
        ...
        "-o",
        str(out_hap_bam),
        # HybridStage1 writes unsorted BAM, rather than SAM, to stdout.
    )
...
def hybrid_stage1(
    ...
    # The HybridStage1 driver in the parallel haplotype job writes its FASTQ
    # output to this FIFO. Read it first so the writer is drained while both
    # Stage-1 jobs run concurrently.
